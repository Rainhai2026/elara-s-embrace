...
import { Crown, MessageCircle, Image, Brain, ShieldOff, ArrowLeft, Flame, Zap, Heart } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-card/40 backdrop-blur border border-border/60 rounded-2xl p-6 mb-12">
          ...
          <div className="space-y-3">
            {[
              { label: 'Mensagens por dia', free: '15', pro: 'Ilimitadas' },
        ...
        <div className="text-center space-y-4">
          <Button
            ...
            size="lg"
            className="bg-primary hover:bg-primary/80 text-primary-foreground font-semibold px-8 py-6 text-base rounded-full shadow-lg shadow-primary/30"
          >
